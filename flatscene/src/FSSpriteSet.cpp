...
std::string FSSpriteset::getName() {
    return name;
}

bool FSSpriteset::setName(std::string& name) {
    if (this->name=="") {
        this->name=name;
        return true;
    }
...
void FSSpriteset::loadChipset(std::string& c,Uint8 mode,std::string* cPrev) {
...
void FSSpriteset::loadChipsetSplit(std::string grd,Uint8 mode) {
