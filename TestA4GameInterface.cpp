...
//constructor
CTestA4GameInterface::CTestA4GameInterface(CMessageHandler* pmhParent) : CTestAGameInterface(pmhParent)
{
...
/*
	...
	cams.push_back(new CScrollCamera((CActor*)player[0],new CRectangle(RESOLUCION_X/2,0,RESOLUCION_X/2,RESOLUCION_Y),NULL,0.35));
