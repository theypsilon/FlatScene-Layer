// TestA0GameInterface.cpp: implementation of the CTestA0GameInterface class.
//
//////////////////////////////////////////////////////////////////////
...
//constructor
CTestA0GameInterface::CTestA0GameInterface(CMessageHandler* pmhParent) : CTestAGameInterface(pmhParent)
{
	pulsado = false;
}
...
int CTestA0GameInterface::onIdle() {

	CPlayer* p =player[0];

	if (pulsado) {

		if (p->getUniverse()->getName() == "mapa1") {

			p->m_Scrollxy.set(690,180,0);

		} else if (p->getUniverse()->getName() == "mapa7") {

			p->m_Scrollxy.set(70,400,0);

		} else if (p->getUniverse()->getName() == "pisos") {

			p->m_Scrollxy.set(170,200,2);
		}
...
//on cleanup
int CTestA0GameInterface::onExit()
{
...
void CTestA0GameInterface::onKeyUp(SDLKey sym,SDLMod mod,Uint16 unicode) {
		...
		CTestAGameInterface::onKeyUp(sym,mod,unicode);
}

void CTestA0GameInterface::onKeyDown(SDLKey sym,SDLMod mod,Uint16 unicode) {
	if (sym==SDLK_u) {
